...
var mouseAngle; // Event Listeners

addEventListener('mousemove', function (event) {
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].killTweensOf(mouse);
...
function init() {
  particles = [];
  var hueIncrement = 360 / 500;

  for (var i = 0; i < 500; i++) {
    var x = canvas.width / 2;
    var y = canvas.height / 2;
    var distFromCenter = i;
    particles.push(new Particle(x, y, 5, "hsl(".concat(hueIncrement * i, ", 50%, 50%)"), distFromCenter));
  }
} // Animation Loop
